...
const Form = ({
    ...
    const handleSubmit = async(e) => {
        ...
        e.preventDefault()
        const res = await fetch(`https://chattybox-server.onrender.com/api/${isSignInPage ? 'login' : 'register'}`, {
            method: 'POST',
            headers: {
  ...
  return (
    <div className="bg-light h-screen flex items-center justify-center">
        <div className=" bg-white w-[600px] h-[800px] shadow-lg rounded-lg flex flex-col justify-center items-center">
            <div className=" text-7xl font-extrabold justify-center items-center">WELCOME TO CHATTYBOX {isSignInPage && 'Back'}</div>
